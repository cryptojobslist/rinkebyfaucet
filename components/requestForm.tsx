...
export default function RequestForm() {
  ...
  return (
    <form className='mt-1.5 space-y-3 md:space-x-2' onSubmit={handleSubmit(requestCaptcha)}>
      <div className='w-full border border-purple border-solid rounded p-2'>
        <input
          {...register('address', {
            required: true,
        ...
        />
        <button
          className='md:w-1/5 p-2 px-4 text-white rounded bg-purple opacity-95 hover:opacity-100 active:opacity-90'
          type='submit'>
